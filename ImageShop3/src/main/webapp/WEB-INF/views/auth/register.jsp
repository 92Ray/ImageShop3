...
<div class="auth_register">
    ...
    <form:form id="member" modelAttribute="member" action="/user/register" method="post">
        <table>
            <tr>
    ...
    <div class="user-btn-area">
        <button type="button" id="btnRegister"><spring:message code="action.register" /></button>
